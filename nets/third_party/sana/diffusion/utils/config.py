...
class ModelVideoConfig(ModelConfig):
    ...
    image_embed_channels: int = 1152
    image_gate_init: float = 0.0
...
def model_video_init_config(config: SanaVideoConfig, latent_size: int = 32):
    ...
    return {
        ...
        "image_embed_channels": getattr(config.model, "image_embed_channels", 1152),
        "image_gate_init": getattr(config.model, "image_gate_init", 0.0),
